...
$conexao = mysqli_connect("localhost", "root", "","cafe_gourmet") or die ("erro_1");
  $sql = "SELECT * FROM produtos WHERE codigo='1'";
...
<div id="imagemPrdt">
<img id="zoom_01" src='_imagens/imgA.png' data-zoom-image="_imagens/imgAlarge.png"/>
  <p id="nomeProduto"><?php echo $nome?><br/>R$ <?php echo $preco?></p><br/>

 
    <form id="selecionar" method="post" action= "carrinho.php#sacola" >
...
<footer id="rodape">
   <p id="empresaProm"> Receba nossas ofertas!</p>
      ...
      <form id="promocoes" method="post" action= "produto01.php">
