...
$conexao = mysqli_connect("localhost", "root", "","cafe_gourmet") or die ("erro_1");
  $sql = "SELECT * FROM produtos WHERE codigo='7'";
...
<div id="imagemPrdt">
<img id="zoom_01" src='_imagens/imgG.png' data-zoom-image="_imagens/imgGlarge.png"/>
...
<footer id="rodape">
   <p id="empresaProm"> Receba nossas ofertas!</p>
      ...
      <form id="promocoes" method="post" action= "produto07.php">
