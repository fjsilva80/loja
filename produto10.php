...
$conexao = mysqli_connect("localhost", "root", "","cafe_gourmet") or die ("erro_1");
  $sql = "SELECT * FROM produtos WHERE codigo='10'";
...
<div id="imagemPrdt">
<img id="zoom_01" src='_imagens/imgJ.png' data-zoom-image="_imagens/imgJlarge.png"/>
...
<footer id="rodape">
   <p id="empresaProm"> Receba nossas ofertas!</p>
      ...
      <form id="promocoes" method="post" action= "produto10.php">
