...
$conexao = mysqli_connect("localhost", "root", "","cafe_gourmet") or die ("erro_1");
  $sql = "SELECT * FROM produtos WHERE codigo='8'";
...
<div id="imagemPrdt">
<img id="zoom_01" src='_imagens/imgH.png' data-zoom-image="_imagens/imgHlarge.png"/>
...
<footer id="rodape">
   <p id="empresaProm"> Receba nossas ofertas!</p>
      ...
      <form id="promocoes" method="post" action= "produto08.php">
