...
$conexao = mysqli_connect("localhost", "root", "","cafe_gourmet") or die ("erro_1");
  $sql = "SELECT * FROM produtos WHERE codigo='12'";
...
<div id="imagemPrdt">
<img id="zoom_01" src='_imagens/imgM.png' data-zoom-image="_imagens/imgMlarge.png"/>
...
<footer id="rodape">
   <p id="empresaProm"> Receba nossas ofertas!</p>
      ...
      <form id="promocoes" method="post" action= "produto12.php">
